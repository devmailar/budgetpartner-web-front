...
function PrivacyPolicy(): React.ReactNode {
	return (
		<div className="flex flex-col items-center justify-center bg-radial-gradient w-screen h-screen text-white">
			...
			<ul>
				...
				<li>
					<p>
						...
						&quot;Our&quot; in this Agreement) refers to Budget Partner.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to Budget Partner, accessible from{" "}
						<a href="https://budgetpartner.app" target="_blank" rel="noreferrer">
							https://budgetpartner.app
						</a>
					</p>
				</li>
				<li>
			...
			<ul>
				<li>By email: support@budgetpartner.app</li>
			</ul>
		</div>
	);
}
