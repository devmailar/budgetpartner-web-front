...
function ExtraincomesDialog(): React.ReactNode {
	...
	return (
		<div className="animate__animated animate__slideInUp animate__faster flex flex-col gap-y-6 absolute bottom-0 bg-black w-full h-[70%] md:h-[90%] px-7 pb-5 border border-[#212121] rounded-3xl">
			<button
				type="button"
