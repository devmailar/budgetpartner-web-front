...
function SettingsModal(): React.ReactNode {
	...
	return (
		<Modal index={40} classes="gap-y-3 px-6 py-6 animate__animated animate__fadeInDown animate__faster">
			...
			<div className="flex gap-x-4 justify-between pt-4 border-t border-t-grey">
				<div className="flex flex-col gap-y-6 pr-4 border-r border-r-grey">
				...
				<div className="flex flex-col gap-y-2">
					...
					<button type="button" className="btn bg-red">
						<span className="text-xs">Delete your account</span>
					</button>
				</div>
			</div>
		</Modal>
