...
import type { IResponseError, IRootState, IUser } from "../../src/types";
...
function SettingsModal(): React.ReactNode {
	...
	const [setting, setSetting] = React.useState<Settings>(Settings.ACCOUNT);
	const [hideEmail, setHideEmail] = React.useState<boolean>(false);

	const [removeUserConfirmModal, setRemoveUserConfirmModal] = React.useState<boolean>(false);
					...
					<div className="flex gap-x-4 pt-2 border-t border-t-dark">
						<div className="flex flex-col justify-between pr-4 border-r border-r-dark">
							<div className="flex flex-col gap-y-0.5">
								<button
									type="button"
									className="flex gap-x-2 items-center w-fit py-1"
									onClick={(): void => setSetting(Settings.ACCOUNT)}
								>
								...
								<button
									type="button"
									className="flex gap-x-2 items-center w-fit py-1"
									onClick={(): void => setSetting(Settings.APPEARANCE)}
								>
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										<title>Appearance</title>
										<g clipPath="url(#clip0_282_256)">
											<path
								...
								<button
									type="button"
									className="flex gap-x-2 items-center w-fit py-1"
									onClick={(): void => setSetting(Settings.LANGUAGE)}
								>
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										<title>Language</title>
										<g clipPath="url(#clip0_280_249)">
											<path d="M4 5H11" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
											<path
								...
								<button
									type="button"
									className="flex gap-x-2 items-center w-fit py-1"
									onClick={(): void => setSetting(Settings.SUPPORT)}
								>
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										<title>Support</title>
										<g clipPath="url(#clip0_283_273)">
											<path
												...
												strokeLinejoin="round"
											/>
											<path d="M5 21V14" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
										</g>
										<defs>
							...
							<div className="flex flex-col gap-y-8">
								...
								<div className="flex flex-col gap-y-3">
									<div className="flex flex-col gap-y-1">
										...
										<ol>
											<li className="text-xs text-light font-normal font-rubik">
												{new Date().toDateString()} {`(${new Date().getHours()}:${new Date().getMinutes()})`} - User
												logged in
											</li>
										</ol>
									</div>
									...
									<button
										...
										onClick={(): void => setRemoveUserConfirmModal(true)}
									>
